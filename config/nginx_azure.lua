-- da3be4aba4fbcc8267dac7202ee01442 http://api.2445580392072.proxy.3scale.net:80 http://picsoung.cloudapp.net:80 2555417687612 none http://pokeAPI.2445580392072.proxy.3scale.net:80  2555417687722 none http://okmail.2445580392072.proxy.3scale.net:80 http://okmail.herokuapp.com:80 2555417687932 none --
-- -*- mode: lua; -*-
-- Generated on: 2013-09-09 13:57:31 +0000 --
-- Version:
...
local service = {}
      if ngx.var.service_id == '2555417687612' then
        ...
        ngx.var.proxy_pass = "http://backend_picsoung.cloudapp.net"
      ...
      if ngx.var.service_id == '2555417687722' then
        ...
        ngx.var.proxy_pass = "http://backend_not-entered-url"
